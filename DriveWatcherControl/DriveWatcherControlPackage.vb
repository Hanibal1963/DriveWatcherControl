...
<Guid(DriveWatcherControlPackage.PackageGuidString)>
Public NotInheritable Class DriveWatcherControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "a29f8444-cc80-41ee-8141-fad36ba92a11"
