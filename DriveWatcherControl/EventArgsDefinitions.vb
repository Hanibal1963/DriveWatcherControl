...
''' <summary>Übergibt die argumente für das hinzugefügte Laufwerk.</summary>
Public Structure DriveAddedEventArgs
	...
	''' <summary>Gibt die Gesamtmenge an verfügbarem freiem Speicherplatz in Bytes an, die auf einem Laufwerk verfügbar ist.</summary>
...
''' <summary>Übergibt das entfernte Laufwerk.</summary>
